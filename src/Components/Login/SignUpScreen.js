		...
		<div className={styles.signUpScreen}>
			...
			<form className={styles.form} onSubmit={(e) => handleSignUp(e, text.username, text.email, text.password)}>
				...
				<div className={styles.email__phone}>
					...
					/>
					{val1 && <p className={styles.invalid}>Please enter your email address or phone number</p>}
					{testRegex.email && <p className={styles.invalid}>Please enter a valid email or mobile number</p>}
				</div>
				...
				<div className={styles.password}>
					...
					<div>
						<input
							...
							name='password'
							className={val2 ? styles.invalid__input : testRegex.password ? styles.invalid__input : ''}
							value={text.password}
							onChange={handleChange}
					...
					{testRegex.password && <p className={styles.invalid}>Password must be 6 characters or more</p>}
				</div>
